    ...
    public partial class Form1 : Form
    {
        ...
        private void make_green(int x, int y)
        {
            if (x >= 0 && x < 8 && y >= 0 && y < 8)
            {
                ...
                {
                    //if (player && pic1.Tag.ToString() == "ch_black")
                    //{
                    //    make_red();
                    //}
                    //if (!player && pic1.Tag.ToString() == "ch_white")
                    //{
                    //    make_red();
                    //}
                }
        ...
        private void move(PictureBox pic)
        {
            delete_chess();
            //pic.Image = blocks[0].pb.Image;
            //pic.Tag = blocks[0].pb.Tag;
            //blocks[0].pb.Image = null;
            //blocks[0].pb.Tag = "blank";
            //delete_blocks();
            //if (player)
            //{
            //    player = false;
